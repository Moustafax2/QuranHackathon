  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-950 text-white">
      <div className="mx-auto max-w-5xl px-4 py-12">
        ...
        {/* Room actions */}
        {selectedMode && (authLoading || player) && (
          <div className="mt-8 rounded-2xl border border-gray-800 bg-gray-900 p-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <button
                ...
                disabled={creating || !player}
                className="flex-1 rounded-xl bg-emerald-600 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-emerald-500 disabled:opacity-50"
              >
